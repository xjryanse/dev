...
namespace xjryanse\dev\service\quote;
...
//        exit;
    ...
    public static function ramPreSave(&$data, $uuid) {
        $data['port_base_prize']    = DevQuotePortService::calBasePrizeByQuoteId($uuid);
        $data['page_prize']         = DevQuotePageService::calPrizeByQuoteId($uuid);
