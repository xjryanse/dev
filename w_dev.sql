...
CREATE TABLE `w_dev_api_desc`  (
  ...
  `response` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '20230325返回数据',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'api接口描述说明' ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_dev_bill`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `company_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `project_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '20230228账单归属项目',
  `bill_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求文档名',
  ...
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '开发账单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_dev_bugs`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `company_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `project_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目id',
  `bug_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'bug标题',
  `bug_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'bug内容',
  `need_user` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求人姓名',
  `need_user_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求用户id（用来发模板消息）',
  `reason` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '原因分析',
  `deal_scheme` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '解决方案',
  `has_deal` tinyint(1) NULL DEFAULT 0 COMMENT '已处理？0否；1是',
  `is_radical_cure` tinyint(1) NULL DEFAULT 0 COMMENT '是否根治',
  `deal_user_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求处理人',
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '开发项目bug登记' ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_dev_needs`  (
  ...
  `company_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `project_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目id',
  `group_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '2023-02-27：项目分组',
  `need_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求文档名',
  `page_type` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '页面端口',
  `need_type` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求类型：合同、补充、口头',
  `need_block` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '功能板块',
  `need_desc` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '需求描述',
  `verify_rule` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '验收标准',
  ...
  `need_user` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求人姓名',
  `need_user_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求用户id（用来发模板消息）',
  `need_verify_user` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求验收人',
  `need_verify_wepub_openid` char(28) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '需求验收微信',
  `need_verify_time` datetime(0) NULL DEFAULT NULL COMMENT '需求验收时间',
  `has_verify` tinyint(1) NULL DEFAULT 0 COMMENT '[20220922]客户已验收',
  `need_deal_user` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求处理人',
  `dev_finish` tinyint(1) NULL DEFAULT 0 COMMENT '是否开发完成',
  `dev_finish_time` datetime(0) NULL DEFAULT NULL,
  `dev_desc` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '开发结果描述',
  `need_deal` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `needStatus` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci GENERATED ALWAYS AS (if(`has_settle`,_utf8mb4'finish',if(((`need_verify_user` <> _utf8mb3'') and (`need_verify_user` is not null)),_utf8mb4'to_settle',if(`dev_finish`,_utf8mb4'to_check',if(`has_confirm`,_utf8mb4'dealing',_utf8mb4'to_confirm'))))) VIRTUAL NULL,
  ...
  `bill_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '0831:对账编号',
...
CREATE TABLE `w_dev_needs_dtl`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `company_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `need_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求的id',
  `pid` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '父级需求详情',
  ...
  `deal_status` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'todo,doing,finish:处理状态',
  `deal_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '处理结果',
...
CREATE TABLE `w_dev_needs_group`  (
  ...
  `project_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目id',
  `group_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求组标题',
  `group_desc` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求组描述',
  `cust_user_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '直接：客户需求对接人',
  `third_user_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '间接：第三方需求对接人',
  `functions` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '实现功能',
  `except_desc` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '排除信息描述',
  ...
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '需求组' ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_dev_project`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `company_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `project_title` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求文档名',
  `project_logo` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目logo',
  `customer_manager` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '0922:客户对接人',
  `project_manager` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目经理',
  ...
  `finish_time` date NULL DEFAULT NULL COMMENT '项目结束维护日期',
...
CREATE TABLE `w_dev_project_ext`  (
  ...
  `company_id` int(11) NULL DEFAULT NULL,
  `project_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目id',
  `old_finish_time` date NULL DEFAULT NULL COMMENT '原到期日',
  `new_finish_time` date NULL DEFAULT NULL COMMENT '新到期日',
  `ext_days` int(11) NULL DEFAULT NULL COMMENT '续费天数',
  `from_table` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '续费来源表，订单，优惠券使用记录表等',
  `from_table_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '续费来源表_id，不一定是订单，也有可能是优惠券兑换',
  `sort` int(11) NULL DEFAULT 1000 COMMENT '排序',
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '状态(0禁用,1启用)',
  `has_used` tinyint(1) NULL DEFAULT 0 COMMENT '有使用(0否,1是)',
  `is_lock` tinyint(1) NULL DEFAULT 0 COMMENT '锁定（0：未锁，1：已锁）',
  ...
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '项目续期' ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_dev_project_page`  (
  ...
  `company_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `project_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '项目id',
  `page_code` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '页面编码',
  `module` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '模块',
  `controller` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '控制器',
  `action` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '方法',
  `admKey` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '页面key',
  `page_desc` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '页面描述',
  `url` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '项目经理',
  `sort` int(11) NULL DEFAULT 1000 COMMENT '排序',
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '状态(0禁用,1启用)',
  `has_used` tinyint(1) NULL DEFAULT 0 COMMENT '有使用(0否,1是)',
  `is_lock` tinyint(1) NULL DEFAULT 0 COMMENT '锁定（0：未锁，1：已锁）',
...
CREATE TABLE `w_dev_project_time`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `company_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `project_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需求id',
  `belong_date` date NULL DEFAULT NULL COMMENT '日期',
  `timescope` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '时间范围',
  `eff_hours` decimal(10, 1) NULL DEFAULT 1000.0 COMMENT '有效工时',
  `works_desc` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '工作描述',
  `sort` int(11) NULL DEFAULT 1000 COMMENT '排序',
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '状态(0禁用,1启用)',
  `has_used` tinyint(1) NULL DEFAULT 0 COMMENT '有使用(0否,1是)',
  `is_lock` tinyint(1) NULL DEFAULT 0 COMMENT '锁定（0：未锁，1：已锁）',
  ...
  INDEX `update_time`(`update_time`) USING BTREE,
  INDEX `status`(`status`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '项目工时报表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `w_dev_project_user`  (
  ...
  `role` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'manager:项目经理；developer:开发者；customer:客户；tester:测试',
  `sort` int(11) NULL DEFAULT 1000 COMMENT '排序',
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '状态(0禁用,1启用)',
  `has_used` tinyint(1) NULL DEFAULT 0 COMMENT '有使用(0否,1是)',
  `is_lock` tinyint(1) NULL DEFAULT 0 COMMENT '锁定（0：未锁，1：已锁）',
...
CREATE TABLE `w_dev_svn`  (
  `id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `company_id` char(19) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '',
  `project_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '文章分类',
  `title` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '文章标题',
  `cate` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '分类',
  `svn` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '二级标题',
  `describe` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '描述内容（用户不可见）',
  `sort` int(11) NULL DEFAULT 1000 COMMENT '排序',
  `status` tinyint(1) NULL DEFAULT 1 COMMENT '状态(0禁用,1启用)',
  `has_used` tinyint(1) NULL DEFAULT 0 COMMENT '有使用(0否,1是)',
  `is_lock` tinyint(1) NULL DEFAULT 0 COMMENT '锁定（0：未锁，1：已锁）',
  ...
  INDEX `creater`(`creater`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '项目svn仓库' ROW_FORMAT = Dynamic;
